...
const ItemDetail = ({ producto }) => {
  ...
  return (
    <div className="container my-4">
      <div className="card item-detail noneHover">
        <div className="row g-0 item-detail-container">
       
        <div className="col-md-2 secundary-image">
  {images.map((imagen) => (
    <img  src={imagen}  key={imagen}  alt="imagen del producto" onClick={() => setCurrentImage(imagen)}  className="img-thumbnail"
    />
  ))}
</div>
          ...
          <div className="col-md-6">
            <div className="card-body text-center text-md-start">
              ...
              {showItemCount ? (
                ...
                <Link to="/cart" className="btn btn-uala mt-4">
                  Terminar mi compra
                </Link>
              )}
            </div>
